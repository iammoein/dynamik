...
>
  <head>
    ...
    <title>Dynamik Project Management System</title>
        ...
        >
          <div class="app-brand demo">
            <a href="index.php" class="app-brand-link">
             ...
             <img src="Planom.svg" alt="" width="34" height="24">
              </span>
              <span class="app-brand-text demo menu-text fw-bold">Dynamik</span>
            </a>
                    ...
                    <li>
                      ...
                      >
                        <span class="align-middle"
                          ><i class="ti ti-sun ti-md me-3"></i>Light</span
                        >
                      </a>
                    </li>
                    <li>
                      ...
                      >
                        <span class="align-middle"
                          ><i class="ti ti-moon-stars ti-md me-3"></i>Dark</span
                        >
                      </a>
                    </li>
                    <li>
                      ...
                      >
                        <span class="align-middle"
                          ><i
                            class="ti ti-device-desktop-analytics ti-md me-3"
                          ></i
                          >System</span
                        >
                      </a>
                    ...
                    <div class="dropdown-shortcuts-list scrollable-container">
                      <div class="row row-bordered overflow-visible g-0">
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          >
                            <i
                              class="ti ti-file-dollar ti-26px text-heading"
                            ></i>
                          </span>
                      ...
                      <div class="row row-bordered overflow-visible g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          >
                            <i
                              class="ti ti-device-desktop-analytics ti-26px text-heading"
                            ></i>
                          </span>
                    ...
                    <li>
                      ...
                      >
                        <div class="d-flex align-items-center">
                          ...
                          <div class="flex-grow-1">
                            <h6 class="mb-0">Sadegh Hejazi</h6>
