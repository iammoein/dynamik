                  ...
                  >
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="row">
                          <div class="col-12">
                            <h5 class="text-white mb-0">Baran Project Status</h5>
                      ...
                      <div class="swiper-slide">
                        <div class="row">
                          <div class="col-12">
                            <h5 class="text-white mb-0">Baran Project Resources</h5>
                            <small>Total Project Resources</small>
                          </div>
                          <div
                            class="col-lg-7 col-md-9 col-12 order-2 order-md-1 pt-md-9"
                          >
                      ...
                      <div class="swiper-slide">
                        <div class="row">
                          <div class="col-12">
                            <h5 class="text-white mb-0">Baran Project Costs</h5>
                            <small>Total Project Costs</small>
                          </div>
                          <div
                            class="col-lg-7 col-md-9 col-12 order-2 order-md-1 pt-md-9"
                          >
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="card h-100">
                    <div class="card-header pb-0">
                      <h5 class="mb-3 card-title">Average Daily Costs</h5>
                      <p class="mb-0 text-body">Total Costs This Month</p>
                      <h4 class="mb-0">$280,450</h4>
                    </div>
                  ...
                  <div class="card h-100">
                    <div class="card-header">
                      <div class="d-flex justify-content-between">
                        <p class="mb-0 text-body">Costs Overview</p>
                  ...
                  <div class="card h-100">
                    ...
                    >
                      <div class="card-title mb-0">
                        <h5 class="mb-1">Sales Reports</h5>
                ...
                <div class="col-md-6">
                  <div class="card h-100">
                    <div class="card-header d-flex justify-content-between">
                      <div class="card-title mb-0">
                        <h5 class="mb-1">Construction Tasks Status</h5>
                      ...
                      <div class="col-12 col-sm-4 col-md-12 col-lg-4">
                        ...
                        <ul class="p-0 m-0">
                          ...
                          >
                            ...
                            <div>
                              <h6 class="mb-0 text-nowrap">New Tasks</h6>
                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex justify-content-between">
                      <div class="card-title mb-0">
                        ...
                        <p class="card-subtitle">Total Materials</p>
                      </div>
                      <div class="dropdown">
                        <button
                          class="btn btn-text-secondary rounded-pill text-muted border-0 p-2 me-n1"
                      ...
                      <ul class="p-0 m-0">
                        ...
                        >
                          <div class="badge bg-label-primary rounded p-1_5">
                            <i class="ti ti-arrow-down-to-arc"></i>
                          </div>
                          <div
                            class="d-flex justify-content-between w-100 flex-wrap"
                          >
                            <h6 class="mb-0 ms-4">Concrete</h6>
                            <div class="d-flex">
                              <p class="mb-0">345</p>
